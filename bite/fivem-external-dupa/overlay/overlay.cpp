...
void i_overlay::menu()
{
	...
	ImGui::Begin(skCrypt("cheat-shop.com"), nullptr, ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoCollapse);
	{
		ImVec2 pos;
		...
		draw->AddText(ImVec2(pos.x + 10, pos.y + 2), ImColor(157,176,242), (skCrypt(("cheat-shop.com"))));
		draw->AddText(ImVec2(pos.x + 10, pos.y + 344), ImColor(100, 100, 100), (skCrypt(("build:"))));
		draw->AddText(ImVec2(pos.x + 45, pos.y + 344), ImColor(157, 176, 242), (skCrypt(("stable"))));
		draw->AddText(ImVec2(pos.x + 475, pos.y + 344), ImColor(157, 176, 242), (("")));
		draw->AddText(ImVec2(pos.x + 530, pos.y + 344), ImColor(100, 100, 100), (skCrypt(("fivem"))));
		ImGui::PopFont();
		...
		ImGui::BeginChild(("main1"), ImVec2(130, 290));
		{
			...
			if (ImGui::Tab(skCrypt(("Vehicle")), "", subtab2 == 6)) subtab2 = 6;
			ImGui::SetCursorPos({ 5, 125 });
			if (ImGui::Tab(skCrypt(("Player-list")), "", subtab2 == 4)) subtab2 = 4;
			ImGui::SetCursorPos({ 5, 155 });
		...
		if (subtab2 == 6)
		{
			...
			ImGui::MenuChild(skCrypt(("Vehicle")), ImVec2(200, 274));
			{
			...
			ImGui::MenuChild(skCrypt(("Option")), ImVec2(200, 274));
			{
				ImGui::SetCursorPos({ 5,15 });
				ImGui::PushItemWidth(175);
				ImGui::SliderFloat(skCrypt(("Boost Value")), &i_exploits::exp().boostvalue, 0.0f, 1000);
			}
			ImGui::EndChild();
			ImGui::PopFont();
		...
		if (subtab2 == 4)
		{
			...
			ImGui::SetCursorPos({ 160, 58 });
			ImGui::MenuChild(skCrypt(("Player-List")), ImVec2(200, 274));
			{
				...
				if (ReplayInterface)
				{
					...
					for (int i = 0U; i < entitylist; i++) 
					{
						...
						if (!searchQuery[0] || strstr(playeridstr.c_str(), searchQuery) != nullptr)
			...
			ImGui::PushFont(global3);
			ImGui::SetCursorPos({ 380, 58 });
			ImGui::MenuChild(skCrypt(("Selected player")), ImVec2(200, 274));
			{
				...
				if (it != i_esp::esp().friends.end())
					ImGui::Text(skCrypt("Friend: true"));
				else
					ImGui::Text(skCrypt("Friend: false"));
		...
		if (subtab2 == 1)
		{
			...
			ImGui::MenuChild(skCrypt(("ESP")), ImVec2(200, 274));
			{
				...
				ImGui::SetCursorPosX(15);
				ImGui::Checkbox(skCrypt("Vehicle Snapline"), &i_esp::esp().vehiclesnapline);
				ImGui::SetCursorPosX(15);
		...
		if (subtab2 == 2)
		{
			...
			ImGui::SetCursorPos({ 160, 58 });
			ImGui::MenuChild(skCrypt("Self"), ImVec2(200, 274));
			{
				ImGui::SetCursorPos({ 15,15 });
				...
				{
					i_exploits::exp().teleporttowaypoint = true;
				}
			...
			ImGui::SetCursorPos({ 380, 58 });
			ImGui::MenuChild(skCrypt("Weapon"), ImVec2(200, 274));
			{
				ImGui::SetCursorPos({ 15,15 });
